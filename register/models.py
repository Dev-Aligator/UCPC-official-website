...
class Teammate(models.Model):
    ...
    MSSV = models.CharField(max_length=30, null=True, blank=False, unique=False, default='22520000', validators=[Validator.MSSVRegex])
    CMND_CCCD = models.CharField(max_length=30, null=False, blank=False, unique=False, default='000000000', validators=[Validator.CMND_CCCDRegex])
    Phone = models.CharField(max_length=11, null=False, blank=False, unique=False, validators=[Validator.PhoneRegex])
